...
/* ---------- Global Styles Injection (Fixes Firefox/Width Issues) ---------- */
const GlobalStyles = () => (
  <style>{`
    body, html, #root {
      margin: 0;
...
export default function App() {
  ...
  const daysToGoal = avgRecent > 0 ? Math.ceil(needed / avgRecent) : "∞";
...
✨ PROJECTIONS
   ...
   • Est. Completion: ${daysToGoal} days (${finishDate})`;
  };
            ...
            <Card title="Report" delay={0.1}>
              ...
              <div style={{ marginTop: "16px", display: "flex", justifyContent: "flex-end" }}>
                <Button onClick={copyReport} style={{ background: copyFeedback === "Copied!" ? "#4ade80" : "#3b82f6", color: "#fff", minWidth: "160px" }}>
                  {copyFeedback === "Copied!" ? "✓ Copied" : "📋 Copy Report"}
                </Button>
              </div>
            </Card>
          </div>
